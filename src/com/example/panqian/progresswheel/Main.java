package com.example.panqian.progresswheel;
...
public class Main extends Activity {
	...
	private com.example.panqian.progresswheel.ProgressWheel pwOne;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pwOne = (com.example.panqian.progresswheel.ProgressWheel) findViewById(R.id.progressBarTwo);
...
//                randomBg(pwOne);
    ...
    private static final class SpinListener implements OnClickListener {
        ...
        private final com.example.panqian.progresswheel.ProgressWheel wheel;
        private final Button spinButton, incButton;
        private final SeekBar seekBar;
        private int cachedProgress = 0;

        SpinListener(com.example.panqian.progresswheel.ProgressWheel wheel, Button spinButton, Button incButton, SeekBar seekBar) {
            this.wheel = wheel;
    ...
    private static void styleRandom(com.example.panqian.progresswheel.ProgressWheel wheel, Context ctx) {
        //圆弧底色
        wheel.setRimShader(null);
        wheel.setRimColor(0xFF00FF00);
        //
        wheel.setCircleColor(0x00666666);
        //进度条颜色等
        wheel.setBarColor(0xFFff0000);
        wheel.setBarWidth(pxFromDp(ctx, 5));
        wheel.setBarLength(pxFromDp(ctx, 10));
        //外轮廓颜色
        wheel.setContourColor(0xFF0000FF);
        wheel.setContourSize(pxFromDp(ctx, 5));

        wheel.setSpinSpeed(4f);
        wheel.setDelayMillis(3);
    }

    private static void randomBg(com.example.panqian.progresswheel.ProgressWheel wheel) {
    ...
    //seekBar  updateListener
    private static class ProgressUpdater implements SeekBar.OnSeekBarChangeListener {

        private final com.example.panqian.progresswheel.ProgressWheel wheel;

        ProgressUpdater(com.example.panqian.progresswheel.ProgressWheel wheel) {
            this.wheel = wheel;
        }
